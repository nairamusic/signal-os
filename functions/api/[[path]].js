...
const ROUTES = {
  ...
  "site/artist-save":      { wp: "/wp-json/nmcsignal/v1/artist-save",      methods: ["POST"] },
  "site/artist-delete":    { wp: "/wp-json/nmcsignal/v1/artist-delete",    methods: ["POST"] },
  "site/shop-products":    { wp: "/wp-json/nmcsignal/v1/shop-products",    methods: ["GET"] },
  "site/product-save":     { wp: "/wp-json/nmcsignal/v1/product-save",     methods: ["POST"] },
  "site/product-delete":   { wp: "/wp-json/nmcsignal/v1/product-delete",   methods: ["POST"] },
